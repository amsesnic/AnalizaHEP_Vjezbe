...
class ReadCutsD : public IClassifierReader {
 ...
 public:
        ...
        fNvars( 4 )
   {
      ...
      fVmin[0] = 0.21254263818264;
      fVmax[0] = 13.0179948806763;
      fVmin[1] = -1.85753166675568;
      fVmax[1] = 1.79134809970856;
      fVmin[2] = -0.737643003463745;
      fVmax[2] = 34.5812873840332;
      fVmin[3] = 0.0384349711239338;
      fVmax[3] = 15.7561540603638;
...
inline void ReadCutsD::InitTransform_1()
{
   ...
   fDecTF_1[0][0][0] = 0.0427546995915;
   fDecTF_1[0][0][1] = -0.000742909696102;
   fDecTF_1[0][0][2] = 0.00138171994217;
   fDecTF_1[0][0][3] = 0.00060646859129;
   fDecTF_1[0][1][0] = -0.000742909696102;
   fDecTF_1[0][1][1] = 0.726282402749;
   fDecTF_1[0][1][2] = -0.0221972236319;
   fDecTF_1[0][1][3] = -0.00294330961031;
   fDecTF_1[0][2][0] = 0.00138171994217;
   fDecTF_1[0][2][1] = -0.0221972236319;
   fDecTF_1[0][2][2] = 21.2984812495;
   fDecTF_1[0][2][3] = 0.00170992600641;
   fDecTF_1[0][3][0] = 0.00060646859129;
   fDecTF_1[0][3][1] = -0.00294330961031;
   fDecTF_1[0][3][2] = 0.00170992600641;
   fDecTF_1[0][3][3] = 0.121588400306;
   fDecTF_1[1][0][0] = 0.0621303796072;
   fDecTF_1[1][0][1] = 0.00197686704687;
   fDecTF_1[1][0][2] = 0.000506134020325;
   fDecTF_1[1][0][3] = 0.000390260558522;
   fDecTF_1[1][1][0] = 0.00197686704687;
   fDecTF_1[1][1][1] = 0.64653546672;
   fDecTF_1[1][1][2] = -0.000687430053678;
   fDecTF_1[1][1][3] = -0.00139564339021;
   fDecTF_1[1][2][0] = 0.000506134020325;
   fDecTF_1[1][2][1] = -0.000687430053678;
   fDecTF_1[1][2][2] = 1.17030561936;
   fDecTF_1[1][2][3] = -0.00294284913913;
   fDecTF_1[1][3][0] = 0.000390260558522;
   fDecTF_1[1][3][1] = -0.00139564339021;
   fDecTF_1[1][3][2] = -0.00294284913913;
   fDecTF_1[1][3][3] = 0.0669172402053;
   fDecTF_1[2][0][0] = 0.0424445562476;
   fDecTF_1[2][0][1] = 0.000983001536139;
   fDecTF_1[2][0][2] = 0.00310365854243;
   fDecTF_1[2][0][3] = 0.00238157925693;
   fDecTF_1[2][1][0] = 0.000983001536139;
   fDecTF_1[2][1][1] = 0.682313985216;
   fDecTF_1[2][1][2] = -0.00280041891387;
   fDecTF_1[2][1][3] = -0.0020445439985;
   fDecTF_1[2][2][0] = 0.00310365854243;
   fDecTF_1[2][2][1] = -0.00280041891387;
   fDecTF_1[2][2][2] = 1.64190848342;
   fDecTF_1[2][2][3] = -0.00414614807208;
   fDecTF_1[2][3][0] = 0.00238157925693;
   fDecTF_1[2][3][1] = -0.0020445439985;
   fDecTF_1[2][3][2] = -0.00414614807208;
   fDecTF_1[2][3][3] = 0.08235357581;
}
