...
class ReadCutsD : public IClassifierReader {
 ...
 public:
        ...
        fNvars( 4 )
   {
      ...
      fVmin[0] = 0.148065939545631;
      fVmax[0] = 12.9625101089478;
      fVmin[1] = -1.73285925388336;
      fVmax[1] = 1.78738069534302;
      fVmin[2] = -2.88117098808289;
      fVmax[2] = 3.07656908035278;
      fVmin[3] = -0.865533590316772;
      fVmax[3] = 8.94777202606201;
...
inline void ReadCutsD::InitTransform_1()
{
   ...
   fDecTF_1[0][0][0] = 0.0427742053679;
   fDecTF_1[0][0][1] = -0.000764056183377;
   fDecTF_1[0][0][2] = -0.00140724898859;
   fDecTF_1[0][0][3] = -0.00350717502516;
   fDecTF_1[0][1][0] = -0.000764056183377;
   fDecTF_1[0][1][1] = 0.726265563887;
   fDecTF_1[0][1][2] = 0.0256765339944;
   fDecTF_1[0][1][3] = 0.00503324427511;
   fDecTF_1[0][2][0] = -0.00140724898859;
   fDecTF_1[0][2][1] = 0.0256765339944;
   fDecTF_1[0][2][2] = 3.22143974778;
   fDecTF_1[0][2][3] = 0.0497644137349;
   fDecTF_1[0][3][0] = -0.00350717502516;
   fDecTF_1[0][3][1] = 0.00503324427511;
   fDecTF_1[0][3][2] = 0.0497644137349;
   fDecTF_1[0][3][3] = 0.560403618387;
   fDecTF_1[1][0][0] = 0.0630702784214;
   fDecTF_1[1][0][1] = 0.00229938583264;
   fDecTF_1[1][0][2] = -0.00302887441444;
   fDecTF_1[1][0][3] = -0.0190041117262;
   fDecTF_1[1][1][0] = 0.00229938583264;
   fDecTF_1[1][1][1] = 0.646992573869;
   fDecTF_1[1][1][2] = -0.0349631381487;
   fDecTF_1[1][1][3] = -0.00570052718713;
   fDecTF_1[1][2][0] = -0.00302887441444;
   fDecTF_1[1][2][1] = -0.0349631381487;
   fDecTF_1[1][2][2] = 2.65761240776;
   fDecTF_1[1][2][3] = 0.0465807412918;
   fDecTF_1[1][3][0] = -0.0190041117262;
   fDecTF_1[1][3][1] = -0.00570052718713;
   fDecTF_1[1][3][2] = 0.0465807412918;
   fDecTF_1[1][3][3] = 0.411785334791;
   fDecTF_1[2][0][0] = 0.0424181536909;
   fDecTF_1[2][0][1] = 0.00111489927363;
   fDecTF_1[2][0][2] = -0.00801419344631;
   fDecTF_1[2][0][3] = -0.00451745820168;
   fDecTF_1[2][1][0] = 0.00111489927363;
   fDecTF_1[2][1][1] = 0.682076610586;
   fDecTF_1[2][1][2] = -0.00633781056601;
   fDecTF_1[2][1][3] = -0.00206847806401;
   fDecTF_1[2][2][0] = -0.00801419344631;
   fDecTF_1[2][2][1] = -0.00633781056601;
   fDecTF_1[2][2][2] = 2.81739910436;
   fDecTF_1[2][2][3] = 0.0626569190622;
   fDecTF_1[2][3][0] = -0.00451745820168;
   fDecTF_1[2][3][1] = -0.00206847806401;
   fDecTF_1[2][3][2] = 0.0626569190622;
   fDecTF_1[2][3][3] = 0.452324584981;
}
